(function(){
        ...
        angular.module('tccmeetings')
            .service('LoginLogoutSrv', LoginLogoutSrv)
        LoginLogoutSrv.$inject = ['$http', '$cookies', '$rootScope', '$location', '$localStorage', 'ngNotify', 'SERVICE_PATH' ];

        function LoginLogoutSrv($http, $cookies, $rootScope, $location, $localStorage, ngNotify, SERVICE_PATH) {
            ...
            serviceFactory.userName = function(){
                return name;
            };
                ...
                $http(requestParams).then(
                    function success(response) {
                        ...
                        if (data.name) {
                            ...
                            ngNotify.set('Email or password that you have entered do not match our records.', {
                                type: 'failure',
                                duration: 5000
                            });
                        }
